...
import RegistCell from './RegisterCell';
...
export default class RegistView extends React.Component {
  ...
  componentDidMount() {
    this.requestData();
    // console.log(
    //   JSON.parse(this.props.navigation.getParam('scannerResult')).data,
    // );
  }
  ...
  _renderItem = (item) => <RegistCell item={item} />;
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text>Message</Text>
        {/* <Text>ID：{JSON.parse(navigation.getParam('scannerResult')).data}</Text> */}
        <FlatList
